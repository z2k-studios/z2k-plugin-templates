...
# Overall process
1. Create a template file (or use Z2K Core to gain access to the Z2K System's suite of template files)
2. Use the How To Guide for creating your own template code.
3. Issue one of the plugin's commands to add new data based on your template

# How to Create Data from a Template
