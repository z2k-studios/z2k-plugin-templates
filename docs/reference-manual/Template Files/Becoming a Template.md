...
To inform the Z2K Template Plugin that a markdown file is a template, simply *put it into a [[Template Folders|Template Folder]]*. That's it! It can then be discovered.
