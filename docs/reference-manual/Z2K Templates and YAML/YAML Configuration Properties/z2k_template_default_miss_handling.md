...
| Key Value            | Result                                                                                                                                                                                                                   |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `finalize-preserve`  | (default) If a miss occurs for a field, the field will be preserved as is in the resultant                                                                                                                               |
| `finalize-clear`     | If a miss occurs for a field, it will clear the field from the result                                                                                                                                                    |
| `finalize-default`   | If a miss occurs for a field, it will use the value of the `default` response as specified in a `{{field-info}}` for the field. If no `default` has been provided, then it will clear the field from the resultant file. |
...
```yaml
---
z2k_template_default_miss_handling: finalize-clear
---
```
