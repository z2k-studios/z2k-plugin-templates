...
title: fieldInfo opts Parameter
sidebar_label: opts
aliases:
- opts
- fieldInfo opts Parameter
---
# fieldInfo opts
The optional `opts` parameter in the [[reference-manual/fieldInfo Helper/fieldInfo Helper]] specifies a list of values that can be selected by a field that has a [[fieldInfo type|type]] of either `singleSelect` or `multiSelect`. 
