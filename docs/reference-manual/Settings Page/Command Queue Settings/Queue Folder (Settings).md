...
> For full details on folder location options, directory structure, and how to place files in the queue, see [[Queue Folder]] inside the [[Command Queues]] section.
