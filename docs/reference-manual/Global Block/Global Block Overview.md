...
- **[[Global Block and field-info|Configure Global Field Behavior]]** – declare `{{field-info}}` settings once and have them apply across every template: prompts, types, suggested values, computed fields, and overrides.
...
> - The block template insertion exception (body not prepended, field-infos still applied) was verified at `main.tsx` lines 2037 and 2040–2045.
