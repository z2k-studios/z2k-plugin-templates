...
- **[[field-info suggest|suggest]]** :: The suggested value to pre-fill in the prompt dialog box. Only accepted if "touched".
...
- **[[field-info fallback|fallback]]** :: The value used if the user never provides a value
...
> Did you know that `{{field-info}}` parameters can have fields in them as well? The prompting interface will dynamically update as you provide data for fields referenced in the prompting and suggest values.
