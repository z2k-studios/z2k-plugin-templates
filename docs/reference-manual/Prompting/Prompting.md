...
3. [[Prompting Defaults]] – What happens when no `{{fieldInfo}}` is specified
...
6. [[Built-in Helpers for Prompting]] – How `{{fieldInfo}}` parameters control the prompting interface
