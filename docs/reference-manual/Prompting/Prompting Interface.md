...
- **Hover text** – Hovering over a field's label reveals diagnostic information: the raw field name, any [[fieldInfo directives|directives]], and dependency relationships.
