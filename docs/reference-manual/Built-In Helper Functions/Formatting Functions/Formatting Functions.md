...
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [[format-date]]                 | Formats a date with a moment.js format string                                                                                                                      |
...
| [[format-string-raw]]           | Prevents any escaping of characters in the final output (default mode for text replacement is to escape markdown relevant characters)                              |
| [[format-string-bulletize]]     | Formats the source data (which may be multilined) into a bulleted list using dashes                                                                                |
...
| [[format-number-to-fixed]]      | Formats a number to a fixed number of decimal places                                                                                                               |
